...
class CSqliteTest extends CTestCase
{
	...
	public function testColumn()
	{
		...
		[
			...
			'dbType'=>['integer','varchar(128)','timestamp','integer','text'],
			...
			'allowNull'=>[false,false,false,false,true],
		];
		$this->checkColumns('posts',$values);
		$values=
		[
			'name'=>['int_col', 'int_col2', 'char_col', 'char_col2', 'char_col3', 'char_col4', 'char_col5', 'float_col', 'float_col2', 'blob_col', 'numeric_col', 'time', 'bool_col', 'bool_col2', 'null_col', 'created_at'],
			'rawName'=>['"int_col"', '"int_col2"', '"char_col"', '"char_col2"', '"char_col3"', '"char_col4"', '"char_col5"', '"float_col"', '"float_col2"', '"blob_col"', '"numeric_col"', '"time"', '"bool_col"', '"bool_col2"', '"null_col"', '"created_at"'],
			'defaultValue'=>[null, 1, null, 'something', null, null, 'NULL', null, '1.23', null, '33.22', '123', null, true, null, null],
			'size'=>[null, null, 100, 100, null, 100, 100, 4, null, null, 5, null, null, null, null, null],
			'precision'=>[null, null, 100, 100, null, 100, 100, 4, null, null, 5, null, null, null, null, null],
			'scale'=>[null, null, null, null, null, null, null, 3, null, null, 2, null, null, null, null, null],
			'dbType'=>['int','integer','char(100)','varchar(100)','text','varchar(100)','varchar(100)','real(4,3)','double','blob','numeric(5,2)','timestamp','bool','boolean','integer','timestamp'],
			'type'=>['integer','integer','string','string','string','string','string','double','double','string','string','string','boolean','boolean','integer','string'],
			'isPrimaryKey'=>[false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
			'isForeignKey'=>[false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
			'allowNull'=>[false,true,false,true,true,true,true,false,true,true,true,true,false,true,true,false],
		];
	...
	public function testCommandBuilder()
	{
		...
		$c=$builder->createInsertCommand($table,['title'=>'test post','create_time'=>time(),'author_id'=>1,'content'=>'test content']);
		...
		$c=$builder->createSqlCommand('SELECT title FROM posts \'t\' WHERE id=:id',[':id'=>3]);
